...
class TestErrorHandlingIntegration:
    ...
    def test_invalid_yaml_syntax(self, tmp_path, runner):
    ...
    def test_missing_required_fields(self, tmp_path, runner):
    ...
    def test_invalid_cron_expressions(self, tmp_path, runner):
    ...
    def test_invalid_date_formats(self, tmp_path, runner):
    ...
    def test_mixed_valid_and_invalid_events(self, tmp_path, runner):
    ...
    def test_warning_handling(self, tmp_path, runner):
    ...
    def test_yaml_schema_validation(self, tmp_path, runner):
    ...
    def test_error_recovery(self, tmp_path, runner):
    ...
    def test_cron_validation_details(self):
    ...
    def test_file_path_security(self, tmp_path, runner):
